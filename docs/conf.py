# -*- coding: utf-8 -*-
#
# OTR-Verwaltung documentation build configuration file, created by
# sphinx-quickstart on Wed May 27 12:48:56 2009.
#
...
version = open('../data/VERSION').read().strip()
...
html_title = "OTR-Verwaltung v" + version
...
htmlhelp_basename = 'OTR-Verwaltungdoc'
